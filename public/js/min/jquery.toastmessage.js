...
(function($)
{var settings={inEffect:{opacity:'show'},inEffectDuration:400,stayTime:2000,text:'',sticky:false,type:'notice',position:'bottom-left',closeText:'',close:null};var methods={init:function(options)
