...
*/
class Application_Form_TabValidators extends Zend_Form
{ 
    ...
    {			    
        $element = new Zend_Form_Element_Text("validatorConstruct");
    ...
    private function _msgErrorInput()
    {
        $element = new Zend_Form_Element_Text('validatorMsgError');
        $element->setLabel('Error message')
        ->setDescription($this->_imgDone)
        ->setDecorators($this->_txtDecorator);
        
        $this->addElement($element, 'msgError');
    }
    
    private function _breakChainOnFailure()
    {
        $element = new Zend_Form_Element_Checkbox('validatorBCOF');
        $element->setLabel('Breack chain on failure ?')
        ->setDescription($this->_imgDone)
        ->setDecorators($this->_txtDecorator);
        
        $this->addElement($element, 'breackChainOnFailure');
    }
}
